...
public class SubInterestActivity extends BaseActivity {
...
//            Intent intent = new Intent(mContext, SignUpAccount.class);
            Intent intent = new Intent(mContext, SignUpProcessingActivity.class);
        ...
        } else if (mUser.getBoolean("isClub")) {
            System.out.println("outta here");
//            setResult(Activity.RESULT_OK, new Intent()
//                    .putExtra(str(R.string.intent_selected_categories), this.categories)
//                    .putExtra(str(R.string.intent_selected_subcategories), this.subcategories));
            finish();
        } else {
            ...
            user.saveInBackground(new SaveCallback() {
                public void done(ParseException e) {
                    if (e == null) {
                        Intent intent = new Intent(SubInterestActivity.this, HomeActivity.class);
