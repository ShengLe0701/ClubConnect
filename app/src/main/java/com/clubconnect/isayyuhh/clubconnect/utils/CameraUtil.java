package com.clubconnect.isayyuhh.clubconnect.utils;
...
import com.clubconnect.isayyuhh.clubconnect.activities.AppConstant;
import com.clubconnect.isayyuhh.clubconnect.activities.SignUpName;
...
public class CameraUtil {
    ...
    public void camera(Activity activity){
        Intent intent = new Intent(activity, SignUpName.class);
